...
BlueBase is, in our opinion, the premier way to build big, fast hybrid apps \(Web, Mobile, Progressive Web Apps & Desktop Apps\) with JavaScript.

One of the many great parts of BlueBase is how it makes you think about apps as you build them. In this document, we'll walk you through the thought process of building a searchable product data table using React.
...
Simply refer to the [React docs](https://github.com/BlueBaseJS/docs/tree/0a61b30410e3b73991b8e1e17f0367eee64e1618/docs/README.md) if you need help executing this step.

### A Brief Interlude: Props vs State <a id="a-brief-interlude-props-vs-state"></a>

There are two types of "model" data in React: props and state. It's important to understand the distinction between the two; skim [the official React docs](https://github.com/BlueBaseJS/docs/tree/0a61b30410e3b73991b8e1e17f0367eee64e1618/docs/interactivity-and-dynamic-uis.html) if you aren't sure what the difference is.
