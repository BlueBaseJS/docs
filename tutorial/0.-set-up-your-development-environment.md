---
description: Currently copied from Gatsby docs. Needs lots of modifications
---

# 0. Set Up Your Development Environment

* [ ] Install Console Logger Plugin



Before you start building your first BlueBase app, you’ll need to familiarize yourself with some core web technologies and make sure that you have installed all required software tools.
...
To install BlueBase and Node.js, it is recommended to use [Homebrew](https://brew.sh/). A little set-up in the beginning can save you from some headaches later on!
...
[![Check node and npm versions in terminal](https://github.com/gatsbyjs/gatsby/raw/master/docs/tutorial/part-zero/01-node-npm-versions.png)](https://github.com/gatsbyjs/gatsby/blob/master/docs/tutorial/part-zero/01-node-npm-versions.png)
...
[![Check gatsby commands in terminal](https://github.com/gatsbyjs/gatsby/raw/master/docs/tutorial/part-zero/05-gatsby-help.png)](https://github.com/gatsbyjs/gatsby/blob/master/docs/tutorial/part-zero/05-gatsby-help.png)
...
[![Check homepage](https://github.com/gatsbyjs/gatsby/raw/master/docs/tutorial/part-zero/04-home-page.png)](https://github.com/gatsbyjs/gatsby/blob/master/docs/tutorial/part-zero/04-home-page.png)

Congrats! This is the beginning of your very first Gatsby site! 🎉

You’ll be able to visit the site locally at [_**http://localhost:8000**_](http://localhost:8000/) for as long as your development server is running. That’s the process you started by running the `gatsby develop` command. To stop running that process \(or to “stop running the development server”\), go back to your terminal window, hold down the “control” key, and then hit “c” \(ctrl-c\). To start it again, run `gatsby develop` again!
...
Now, move on to [**getting to know Gatsby building blocks**](https://github.com/gatsbyjs/gatsby/blob/master/tutorial/part-one).
